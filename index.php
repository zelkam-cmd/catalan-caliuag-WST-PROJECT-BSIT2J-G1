    ...
    <nav class="bg-white border-b p-6 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="space-x-8 text-slate-600 font-medium">
                <a href="index.php" class="text-dental-600 border-b-2 border-dental-600 pb-1">Home</a>
                <a href="view_patients.php" class="hover:text-dental-600 transition">Database</a>
                <a href="add.php" class="hover:text-dental-600 transition">Register</a>
            </div>
        </div>
    </nav>
